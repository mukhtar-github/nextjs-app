  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        <p>
          I am <strong>Mukhtar</strong>, a MERN Stack Developer.<br /> So far, the time metrics in my programming journey has amounted to 2200 hours plus, averaging working 3 hours per day for two consecutive years on a streak.<br />
          I'm currently working on a SaaS Project named VIMAP.<br /> VIMAP is an acronym for Vehicles Information Management Application. MERN Stack is the technology used for the building the software application.<br /> The software's function is to collect, store, and get information about vehicles in organizations. And to also enable printing vehicle's info in pdf, word, etc.<br /> When my knowledge grew stronger I will want to add more features like GPS tracking, maps, and vehicle's inventory features.<br />
